...
cc_appendSRCforCaptionsJS += "remoteScript.innerHTML = \"<script id='ccGetCaptionScript' src='http://www.projectpossibility.org/projects/webcaption/URL_test_r.php?mode=getCaption&domain=\" + window.location.href.split('?')[0] +\"&url_id=\" + window.location.href.split('?')[1].split('=')[1].split('&')[0] + \"'/>\";";
...
objUIScript.src = "http://www.projectpossibility.org/projects/webcaption/cc_UI_CaptionsScript_r.js";
...
//cross site:
  ...
  remoteScript.innerHTML = "<script src='http://www.projectpossibility.org/projects/webcaption/URL_test_r.php?mode=captionExist&domain=" + window.location.href.split('?')[0] +"&url_id=" + window.location.href.split('?')[1].split('=')[1].split('&')[0] + "'/>Calling...";
...
cc_writePlayerDivJS += "objUIScript.src=\"http://www.projectpossibility.org/projects/webcaption/cc_UI_Script_r.js\";";
