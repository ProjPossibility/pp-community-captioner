...
cc_writePlayerDivJS += "cc_styleInPlayer.innerHTML+=\"body\";";
...
cc_writePlayerDivJS += "cc_styleInPlayer.innerHTML+= \"}\";";
cc_writePlayerDivJS += "cc_styleInPlayer.innerHTML+= \"	\";";
cc_writePlayerDivJS += "cc_styleInPlayer.innerHTML+= \"body.section-1 #menu li#nav-1 a, \";";
cc_writePlayerDivJS += "cc_styleInPlayer.innerHTML+= \"body.section-2 #menu li#nav-2 a,\";";
cc_writePlayerDivJS += "cc_styleInPlayer.innerHTML+= \"body.section-3 #menu li#nav-3 a\";";
cc_writePlayerDivJS += "cc_styleInPlayer.innerHTML+= \"{\";";
cc_writePlayerDivJS += "cc_styleInPlayer.innerHTML+= \"	background : #fff;\";";
cc_writePlayerDivJS += "cc_styleInPlayer.innerHTML+= \"	border-bottom : 1px solid #fff;\";";
cc_writePlayerDivJS += "cc_styleInPlayer.innerHTML+= \"	color : #000;\";";
...
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"				function update( num )\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"				{\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"				 	for( var i = 1 ; i <= 3 ; i++ )\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"				 	{\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"				 		document.getElementById( 'content' + i ).style.display = \\\"none\\\" ;\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"				 	}\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"				\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					document.getElementById( 'content' + num ).style.display = \\\"inline\\\" ;\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					document.getElementsByTagName( \\\"body\\\" )[0].className = \\\"section-\\\" + num ;\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"				}\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"				function removeRow( id )\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"				{\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					document.getElementById(\\\"divCaptions\\\").removeChild( document.getElementById( id ) ) ;\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"				}\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"				var counter = 0 ;\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"				function AddNewRow()\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"				{\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					var objTable,objTBody,objTR,objTD,objDIV;\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objDIV=document.createElement(\\\"div\\\");\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objDIV.setAttribute( \\\"style\\\" , \\\"padding : 10px\\\" );\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objTable=document.createElement(\\\"table\\\");\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objTBody=document.createElement(\\\"tbody\\\");\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objTR=document.createElement(\\\"tr\\\");\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objTD=document.createElement(\\\"td\\\");\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objDIV.id = counter + \\\":R\\\" ;\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objTD.innerHTML=\\\"Start: \\\";\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objTD.setAttribute(\\\"style\\\" , \\\"font-family: courier ; font-weight: bold ; font-size : 12px\\\");\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objTR.appendChild(objTD);\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objSP=document.createElement(\\\"span\\\");\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objSP.id=counter+\\\":S\\\";\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objSP.innerHTML = \\\"0:0\\\" ;\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objSP.setAttribute( 'style' , 'font-weight: normal' );\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objTD.appendChild(objSP);\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objTD=document.createElement(\\\"td\\\");\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objTD.innerHTML=\\\"<img src = 'plus.gif' id='\\\"+counter+\\\":SINC' onclick='javascript:IncrementTime(\\\"\\\"+counter+\\\":S\\\")' /><img src = 'minus.gif' id='\\\"+counter+\\\":SDEC' onclick='javascript:DecrementTime(\\\"\\\"+counter+\\\":S\\\")' />\\\";\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objTR.appendChild(objTD);\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objTD=document.createElement(\\\"td\\\");\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objTD.innerHTML=\\\"- End: \\\";\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objTD.setAttribute(\\\"style\\\" , \\\"font-family: courier ; font-weight: bold ; font-size : 12px\\\");\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objTR.appendChild(objTD);\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objSP=document.createElement(\\\"span\\\");\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objSP.id=counter+\\\":E\\\";\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objSP.innerHTML = \\\"0:0\\\";\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objSP.setAttribute( 'style' , 'font-weight: normal' );\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objTD.appendChild(objSP);\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objTD=document.createElement(\\\"td\\\");\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objTD.innerHTML=\\\"<img src = 'plus.gif' id='\\\"+counter+\\\":EINC' onclick='javascript:IncrementTime(\\\"\\\"+counter+\\\":E\\\")' /><img src = 'minus.gif' id='\\\"+counter+\\\":EDEC' onclick='javascript:DecrementTime(\\\"\\\"+counter+\\\":E\\\")' />\\\";\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objTR.appendChild(objTD);\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objTD=document.createElement(\\\"td\\\");\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objTD.setAttribute( 'rowspan' , 2 );\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objTD.setAttribute( 'style' , 'padding : 10px' );\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objTR.appendChild(objTD);\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objA=document.createElement(\\\"a\\\");\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objA.id = counter+\\\":A\\\";\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objA.setAttribute( 'href' , \\\"javascript:removeRow('\\\" + objDIV.id + \\\"')\\\" );\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objA.setAttribute( 'style' , \\\"text-decoration: none ; font-family: courier ; font-size: 24px ; font-weight: bold ;\\\" );\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objTD.appendChild(objA);\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objT=document.createTextNode(\\\"X\\\");\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objA.appendChild(objT);\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objTBody.appendChild(objTR);\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objTR=document.createElement(\\\"tr\\\");\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objTD=document.createElement(\\\"td\\\");\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objTD.innerHTML=\\\"<input type='text' size = 50 id='\\\"+counter+\\\":CAPTION' />\\\";\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objTD.setAttribute( 'colspan' , 4 ) ;\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objTR.appendChild(objTD);\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objTBody.appendChild(objTR);\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objTable.appendChild(objTBody);\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objDIV.appendChild(objTable);\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objDIV.style.overflow=\\\"auto\\\";\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					document.getElementById(\\\"divCaptions\\\").appendChild(objDIV);\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					objDIV=document.createElement(\\\"div\\\");\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					document.getElementById(\\\"divCaptions\\\").appendChild(objDIV);\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					counter++;\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"				}\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"				\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"				function IncrementTime(id)\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"				{\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					var obj=document.getElementById(id);\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					var value=obj.innerHTML;\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					var mm;\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					var ss;\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					if(value==\\\"\\\")\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					{\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"						mm=0;\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"						ss=1;	\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"						\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"						obj.innerHTML=mm+\\\":\\\"+ss;\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					}\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					else\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					{\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"						if( id.substring( id.length - 1 ) == \\\"S\\\" )\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"						{\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"							objE = document.getElementById( id.substring( 0 , id.length - 1 ) + \\\"E\\\" ) ; \";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"							valueE = objE.innerHTML ;\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"							mmE = parseInt(valueE.split(\\\":\\\")[0],10);\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"							ssE = parseInt(valueE.split(\\\":\\\")[1],10);	\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"						}\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"	\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"						mm=parseInt(value.split(\\\":\\\")[0],10);\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"						ss=parseInt(value.split(\\\":\\\")[1],10);\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"							\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"						if(ss%59==0 && ss!=0)\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"						{\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"							ss=0;\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"							mm++;\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"						}\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"						else\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"						{\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"							ss++;\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"						}\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"						obj.innerHTML=mm+\\\":\\\"+ss;\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"						\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"						if( id.substring( id.length - 1 ) == \\\"S\\\" )\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"						{\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"							if( mm > mmE )\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"							{\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"								mmE = mm ;\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"								ssE = ss ;\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"							}\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"							else if( mm == mmE && ss > ssE )\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"							{\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"								ssE = ss ;\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"							}\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"							objE.innerHTML = mmE + \\\":\\\" + ssE ;\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"						}\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					}\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"				}\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"				\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"				function DecrementTime(id)\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"				{\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"						\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					var obj=document.getElementById(id);\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					var value=obj.innerHTML;\";";
...
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"						ss=parseInt(value.split(\\\":\\\")[1],10);\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"						if( id.substring( id.length - 1 ) == \\\"E\\\" )\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"						{\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"							objS = document.getElementById( id.substring( 0 , id.length - 1 ) + \\\"S\\\" ) ; \";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"							valueS = objS.innerHTML ;\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"							mmS = parseInt(valueS.split(\\\":\\\")[0],10);\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"							ssS = parseInt(valueS.split(\\\":\\\")[1],10);	\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"							if( mmS == mm && ssS == ss )\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"							{\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"								return ;\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"							}\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"						}\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"			\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"						if(ss==0 && mm!=0)\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"						{\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"							ss=59;								\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"							\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"							mm--;\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"						}\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"						else \";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"						{\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"							if(mm==0 && ss==0)\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"							{\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"							}\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"							else\";"; 
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"							{\";";
...
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"				}\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"				\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"    function Change(id,type,category)\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"    {\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"        \";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"        var obj=document.getElementById(id);\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"        var newObj;\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"            \";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"        if(obj.type!=\\\"textarea\\\" && obj.type!=\\\"text\\\")\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"        {\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"            \";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"            \";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"            newObj=document.createElement(type);\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"            if(type==\\\"textarea\\\")\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"            {\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"                newObj.rows=\\\"5\\\";\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"                newObj.cols=\\\"50\\\";\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"            }\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"            else\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"            {\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"                newObj.type=\\\"text\\\";\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"                newObj.style.width=\\\"95%\\\" ;    \";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"            }\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"            newObj.value=obj.innerHTML;\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"            newObj.id=id;\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"            \";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"            newObj.onblur=function(){Change(id,type,category)};\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"            newObj.className=\\\"txt\\\";\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"            obj.parentNode.replaceChild(newObj,obj);\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"        }\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"        else\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"        {\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"            \";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"            newObj=document.createElement(\\\"a\\\");\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"            newObj.id=id;\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"            newObj.innerHTML=obj.value;\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"            newObj.href=\\\"javascript:Change('\\\"+id+\\\"','\\\"+type+\\\"','\\\"+category+\\\"')\\\";\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"            \";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"            newObj.style.color=\\\"Black\\\";\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"            obj.parentNode.replaceChild(newObj,obj);\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"        }\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"    }\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"				\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"</script>\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"<div class = \\\"section-1\\\" >\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"\";";
...
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"			<br /> \";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"			Credits: \";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"			<br /><br /> \";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"			<ul>\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"			<li> <b> Amgen </b> </li>\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"				<ul>		\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"			    		<li> Ely Lerner </li> \";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"				</ul>\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"			<li> <b> USC </b> </li>\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"				<ul>\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"	    				<li> Jeffrey Chan </li>\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"		    			<li> Chaitanya Ramavajjala </li>\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"		    			<li> Chetan Sharma </li>\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"    					<li> Raed Shomali </li>\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"				</ul> \";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"			</ul>\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"			</div>\";";
...
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"</div>\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"<script> update(1); </script> /*should only work once*/\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"</div>\";";
