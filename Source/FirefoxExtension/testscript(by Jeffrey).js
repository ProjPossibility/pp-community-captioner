...
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"					document.getElementById( \\\"bodyDiv\\\" ).className = \\\"section-\\\" + num ;\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"				}\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"\";";
cc_writePlayerDivJS += "cc_objDIV.innerHTML+= \"\";";
...
insertCaptionButtonsScript.innerHTML = "function insertCaptionButtons()";
insertCaptionButtonsScript.innerHTML +="{";

//DEBUG
insertCaptionButtonsScript.innerHTML +="alert('inside insert caption buttons');";
...
addButtonsScript.innerHTML = "insertCaptionButtons();";
